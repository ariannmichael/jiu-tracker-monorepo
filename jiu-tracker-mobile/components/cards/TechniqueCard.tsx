...
const CATEGORY_CONFIG: Record<
  Category,
  { label: string; icon: IconName; gradient: readonly [string, string] }
> = {
  [Category.Submission]: {
    label: "Submission",
    icon: "arm-flex",
...
const DIFFICULTY_CONFIG: Record<Difficulty, { label: string; color: string }> = {
  [Difficulty.Beginner]: { label: "Beginner", color: COLORS.ACCENT_GREEN },
  [Difficulty.Intermediate]: { label: "Intermediate", color: COLORS.ACCENT_ORANGE },
  [Difficulty.Advanced]: { label: "Advanced", color: COLORS.ACCENT_PINK },
};
